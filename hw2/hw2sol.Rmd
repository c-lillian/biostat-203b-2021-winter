...
# death (using hospital_expire_flag)
q4.all_death <- q4.all %>% 
...
# admitmonthday
ggplot(data = q4.all_admitmonthday, mapping = aes(admitmonthday)) +
...
# death
ggplot(data = q4.all, mapping = aes(hospital_expire_flag)) +
  geom_bar(aes(fill = hospital_expire_flag)) +
  annotate(geom = "text", x = 1:2, 
           y = count_death, 
  ...
  labs(x = "Status", y = "Count",
       title = "Vital Status of Patient on Discharge")
...
```{r Q7 reading in chartevents, include = F, eval = T}
